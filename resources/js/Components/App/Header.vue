...
<template>
    <div class="flex items-center gap-2">
        <Link :href="route('dashboard')" class="text-accent-800 hover:opacity-90 transition">
        ...
        <div class="flex flex-col">
            <Link :href="route('dashboard')" class="text-2xl font-bold leading-none tracking-tight text-gray-800 hover:text-accent-800 transition">
                {{ appName }}
            </Link>

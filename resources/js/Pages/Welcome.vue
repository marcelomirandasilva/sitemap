            ...
            <header class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-20">
                    ...
                    <nav class="hidden md:flex space-x-6 text-sm font-medium text-gray-600">
                        <a href="#" class="hover:text-[#a4332b] transition">SUPORTE</a>
                        <a href="#" class="hover:text-[#a4332b] transition">AJUDA</a>
                    ...
                    <div class="p-8 md:p-10">
                        ...
                        <div v-if="activeTab === 'signup'" class="space-y-6">
                            <h2 class="text-xl text-gray-600 font-light mb-6">
                                Create and maintain sitemaps for your websites
                            </h2>
                            ...
                            <div class="space-y-4 text-left">
                                ...
                                <div>
                                    <input 
                                        type="email" 
                                        placeholder="* Enter Your Email address to create a free account..." 
                                        class="w-full border-0 border-b border-gray-300 px-0 py-2 text-gray-700 placeholder-gray-400 focus:ring-0 focus:border-blue-500 transition"
                                    >
                                </div>
                                <div class="flex items-start gap-3 mt-4">
                                    ...
                                    <label for="terms" class="text-sm text-gray-500">
                                        * I have read and agree with the <a href="#" class="text-[#a4332b] font-bold hover:underline">Privacy Policy</a> and <a href="#" class="text-[#a4332b] font-bold hover:underline">Terms of Use</a> of the service
                                    </label>
                                </div>
                            </div>

                            <button class="w-full sm:w-auto bg-[#a4332b] hover:bg-[#8f2c25] text-white font-bold py-3 px-12 rounded shadow-md uppercase tracking-wide mt-4 transition">
                                Create Sitemap
                            </button>
                        ...
                        <div v-if="activeTab === 'login'" class="space-y-6">
                            ...
                            <div class="text-center mt-6">
                                <button class="w-full sm:w-auto bg-[#a4332b] hover:bg-[#8f2c25] text-white font-bold py-3 px-12 rounded shadow-md uppercase tracking-wide transition">
                                    LOGIN
                                </button>
                                
                                <div class="mt-4">
                                     <a href="#" class="text-[#a4332b] font-bold hover:underline text-sm border-b border-[#a4332b] border-dashed pb-0.5">Forgot password?</a>
                                </div>
                            </div>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                    ...
                    <div class="p-6 bg-gray-50 md:col-span-1 flex flex-col justify-center">
                        <h3 class="text-lg font-bold text-gray-800 mb-2">Funcionalidades</h3>
                        <p class="text-sm text-gray-500">Compare os recursos incluídos</p>
                    </div>

                    <!-- Free Plan -->
                    <div class="p-6 text-center">
                        <h3 class="text-2xl font-bold text-green-600 mb-1">Grátis!</h3>
                        <p class="text-sm text-gray-500 mb-6">Para sites pequenos</p>
                    ...
                    <div class="p-6 text-center bg-blue-50/30">
                        <h3 class="text-2xl font-bold text-[#a4332b] mb-1">PRO</h3>
                        <p class="text-sm text-gray-500 mb-6">A partir de $4.19/mês</p>
                ...
                <div class="border-t border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Sitemap XML Padrão & Mobile</div>
                    ...
                    <!-- Item 2 -->
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Crawling Assíncrono Rápido</div>
                        <div class="p-3 flex justify-center items-center"><span class="text-green-500 text-xl">✔</span></div>
                        <div class="p-3 flex justify-center items-center bg-blue-50/30"><span class="text-green-500 text-xl">✔</span></div>
                    </div>
                    <!-- Item 3 -->
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Detecção de Links Quebrados</div>
                        <div class="p-3 flex justify-center items-center"><span class="text-green-500 text-xl">✔</span></div>
                        <div class="p-3 flex justify-center items-center bg-blue-50/30"><span class="text-green-500 text-xl">✔</span></div>
                    </div>
                    <!-- Item 4 (Pro Only) -->
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Sitemaps de Imagem (Metadados Reais + EXIF)</div>
                        <div class="p-3 flex justify-center items-center"><span class="text-gray-300 text-sm">✖</span></div>
                        <div class="p-3 flex justify-center items-center bg-blue-50/30"><span class="text-green-500 text-xl">✔</span></div>
                    </div>
                     <!-- Item 5 (Pro Only) -->
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Sitemaps de Vídeo (YouTube/Vimeo/Local)</div>
                        <div class="p-3 flex justify-center items-center"><span class="text-gray-300 text-sm">✖</span></div>
                        <div class="p-3 flex justify-center items-center bg-blue-50/30"><span class="text-green-500 text-xl">✔</span></div>
                    </div>
                     <!-- Item 6 (Pro Only) -->
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Sitemaps de Notícias (Google News)</div>
                        <div class="p-3 flex justify-center items-center"><span class="text-gray-300 text-sm">✖</span></div>
                        <div class="p-3 flex justify-center items-center bg-blue-50/30"><span class="text-green-500 text-xl">✔</span></div>
                    </div>
                     <!-- Item 7 (Pro Only) -->
                    <div class="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200 hover:bg-gray-50 transition">
                        <div class="p-3 px-6 text-sm font-medium text-gray-700 flex items-center">Acesso à API REST & Webhooks</div>
                        <div class="p-3 flex justify-center items-center"><span class="text-gray-300 text-sm">✖</span></div>
                        <div class="p-3 flex justify-center items-center bg-blue-50/30"><span class="text-green-500 text-xl">✔</span></div>
                    </div>
                </div>
        ...
        <footer class="border-t border-gray-200 bg-white pt-10 pb-6">
            <div class="max-w-6xl mx-auto px-4 text-center">
                <nav class="flex flex-wrap justify-center gap-6 mb-6 text-sm text-[#a4332b] font-medium">
                    ...
                    <a href="#" class="hover:underline">API para Desenvolvedores</a>
